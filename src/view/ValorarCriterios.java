...
public class ValorarCriterios extends Visible {
    ...
    public void cargar() {
        super.cargar();
        criterios = controlador.getCriterios();
        generarComparadores(criterios);
    }
    ...
    private void $$$setupUI$$$() {
        ...
        criteriosDatos.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
